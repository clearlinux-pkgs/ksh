...
Version  : 1.0.9
Release  : 12
URL      : https://github.com/ksh93/ksh/archive/v1.0.9/ksh-1.0.9.tar.gz
Source0  : https://github.com/ksh93/ksh/archive/v1.0.9/ksh-1.0.9.tar.gz
...
%prep
%setup -q -n ksh-1.0.9
cd %{_builddir}/ksh-1.0.9
%patch -P 1 -p1
pushd ..
cp -a ksh-1.0.9 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720047152
